...
public class Test_0059_VarietyAlarmUiCheck extends UiAutomatorTestCase{ 
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_VarietyAlarmUiCheck() throws UiObjectNotFoundException{
		...
		mm.log("Step 2 : check VarietyAlarmSearch page.");
