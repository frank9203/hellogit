...
public class Test_0063_FontsUiCheck extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_FontsUiCheck() throws UiObjectNotFoundException{
		...
		mm.log("Step 2 : check FontsSearch page.");
