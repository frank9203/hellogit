...
public class Test_0076_DialContacksSearch extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_DialContacksSearch() throws UiObjectNotFoundException{
...
//		mm.waitFor(1);
		...
		mm.log("Step 2 : Check DialContacksSearch.");
		mm.move(500, 1700, 500, 500);
		mm.getObjectByText("拨号与联系人", "android.widget.TextView").click();
		mm.waitFor(2);
		mm.saveScreenshot("DialContacks.png");
		mm.log("Step 3 : DialContacksSearch ");
