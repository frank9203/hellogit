...
public class Test_0072_SmsThemeUiCheck extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_SmsThemeUiCheck() throws UiObjectNotFoundException{
		...
		mm.log("Step 2 : check SmsThemeSearch page.");
		mm.move(500, 1700, 500, 500);
