...
public class Test_0081_BootSoundSearch extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_BootSoundSearch() throws UiObjectNotFoundException{
...
//		mm.waitFor(1);
		...
		mm.log("Step 2 : Check BootSoundSearch.");
		mm.move(500, 1700, 500, 500);
		mm.getObjectByText("开机音乐", "android.widget.TextView").click();
		mm.waitFor(2);
		mm.saveScreenshot("BootSound.png");
		mm.log("Step 3 : BootSoundSearch ");
		...
		search.click() ;
		mm.waitFor(2);
		mm.saveScreenshot("BootSound1.png");
		mm.waitFor(2);
		mm.pressBack(5);
		mm.pressHome();
