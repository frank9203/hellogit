...
public class Test_0044_DesktopWallpaperSetLockScreenWallpaper extends UiAutomatorTestCase {
	public Marmot mm;
	public Checker cc;
	...
	public void test_0207_DesktopWallpaperSetLockScreenWallpaper() throws UiObjectNotFoundException{
...
//		mm.waitFor(1);
		...
		mm.waitFor(2);
		mm.saveScreenshot("List.png");
		mm.click(282, 450);//第一张图片坐标
		mm.waitFor(2);
		mm.click(978, 1819);
		mm.waitFor(2);
		mm.saveScreenshot("Mylist.png");
		mm.click(655,1421);//点击设置成锁屏壁纸
		mm.saveScreenshot("LockScreenWallpaper1.png");
		mm.waitFor(2);
		mm.pressBack(5);
		try {
			getUiDevice().sleep();
