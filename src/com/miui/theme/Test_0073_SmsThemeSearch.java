...
public class Test_0073_SmsThemeSearch extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_SmsThemeSearch() throws UiObjectNotFoundException{
...
//		mm.waitFor(1);
		...
		//设置搜索词语
		/*
		UiObject Setting = new UiObject(new UiSelector().className("android.widget.FrameLayout").index(0))
