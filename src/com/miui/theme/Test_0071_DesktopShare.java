...
public class Test_0071_DesktopShare extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_DesktopDownload() throws UiObjectNotFoundException{
...
//		mm.waitFor(1);
		...
		mm.log("Step 2 : Check DesktopSearch.");
