...
public class Test_0056_NotificationRingtoneSearch extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	   ...
	   public void test_0001_NotifiactionRingtoneSearch() throws UiObjectNotFoundException{
		   ...
		   mm.log("Step 1 : Open Unlock");
			...
			mm.log("Step 3 : NotifiactionRingtoneSearch");
