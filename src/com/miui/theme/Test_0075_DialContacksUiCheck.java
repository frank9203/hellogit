...
public class Test_0075_DialContacksUiCheck extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_DialContacksUiCheck() throws UiObjectNotFoundException{
		...
		mm.log("Step 2 : check DialContacksSearch page.");
		mm.move(500, 1700, 500, 500);
