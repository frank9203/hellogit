...
public class Test_0079_BootAnimationSearch extends UiAutomatorTestCase {
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_BootAnimationSearch() throws UiObjectNotFoundException{
...
//		mm.waitFor(1);
		...
		mm.log("Step 2 : Check BootAnimationSearch.");
		mm.move(500, 1700, 500, 500);
		mm.getObjectByText("开机动画", "android.widget.TextView").click();
		mm.waitFor(2);
		
		mm.log("Step 3 : BootAnimationSearch ");
