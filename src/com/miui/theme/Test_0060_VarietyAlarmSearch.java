...
public class Test_0060_VarietyAlarmSearch extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_VarietyAlarmSearch() throws UiObjectNotFoundException{
...
//		mm.waitFor(1);
		...
		mm.waitFor(2);
		mm.saveScreenshot("Varietyalarm.png");
		mm.log("Step 3 : VarietyAlarmSearch ");
		...
		search.click() ;
		mm.waitFor(2);
		mm.saveScreenshot("VarietyAlarmSearch.png");
		mm.waitFor(2);
		mm.pressBack(5);
		mm.pressHome();
