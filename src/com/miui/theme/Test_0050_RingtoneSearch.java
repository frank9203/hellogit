...
public class Test_0050_RingtoneSearch extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_RingtoneSearch() throws UiObjectNotFoundException{
		...
		search.click() ;
		mm.waitFor(2);
		mm.saveScreenshot("RingtoneSearch.png");
		mm.waitFor(2);
		mm.pressBack(5);
		mm.pressHome();
	}
