...
public class Test_0069_DesktopUiCheck extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_DesktopUiCheck() throws UiObjectNotFoundException{
		...
		mm.log("Step 2 : check DesktopSearch page.");
