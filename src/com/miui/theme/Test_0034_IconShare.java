...
public class Test_0034_IconShare extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_IconShare() throws UiObjectNotFoundException{
...
//		mm.waitFor(1);
		...
		View1.click() ;
		mm.saveScreenshot("IconShare.png");
		mm.waitFor(2);
		mm.pressBack(5);
		mm.pressHome();
