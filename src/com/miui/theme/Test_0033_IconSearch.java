...
public class Test_0033_IconSearch extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_IconSearch() throws UiObjectNotFoundException{
...
//		mm.waitFor(1);
		...
		search.click() ;
		mm.waitFor(2);
		mm.saveScreenshot("IconSearch.png");
		mm.waitFor(2);
		mm.pressBack(5);
		mm.pressHome();
