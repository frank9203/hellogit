...
public class Test_0082_BootSoundUiCheck extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_BootSoundUiCheck() throws UiObjectNotFoundException{
		...
		mm.log("Step 2 : check BootSoundSearch page.");
		mm.move(500, 1700, 500, 500);
		mm.waitFor(2);
