...
public class Test_0066_NotificationBarUiCheck extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_NotificationUiCheck() throws UiObjectNotFoundException{
		...
		mm.log("Step 2 : check NotificationSearch page.");
