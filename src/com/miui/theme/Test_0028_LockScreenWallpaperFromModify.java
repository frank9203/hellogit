...
public class Test_0028_LockScreenWallpaperFromModify extends UiAutomatorTestCase {
	public Marmot mm;
	public Checker cc;
	...
	public void test_0159_LockScreenWallpaperFromModify() throws UiObjectNotFoundException{
...
//		mm.waitFor(1);
		...
		mm.log("Step 4 : Search LockScreenWallpaper");
		...
		search.click() ;
		mm.waitFor(2);
		mm.saveScreenshot("SearchLockScreemWallpaper.png");
		mm.waitFor(2);
		mm.pressBack(4);
		mm.pressHome();
