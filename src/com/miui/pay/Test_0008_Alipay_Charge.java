...
public class Test_0008_Alipay_Charge extends UiAutomatorTestCase {
    ...
    public void test_0008_mibiCard_Charge() throws UiObjectNotFoundException {
        ...
        mm.clickOnText("支付宝");
        mm.waitFor(3);
        UiObject textfile = new UiObject(new UiSelector().className(
        ...
        mm.waitFor(10);
        FC_ANR("Alipaycharge");
        UiObject Alipay = new UiObject(new UiSelector().className(
         ...
         * mm.waitFor(1);
         * mm.getObjectByClass("android.widget.EditText").setText("abc.abc");
         * mm.waitFor(2); mm.clickOnButton("付款"); mm.waitFor(5);
         * FC_ANR("alipayresult"); cc.assertTextExist("0.01米币充值成功");
         * mm.clickOnText("完成");
         */
    }
