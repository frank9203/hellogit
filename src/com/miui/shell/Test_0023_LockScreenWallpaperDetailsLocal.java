...
public class Test_0023_LockScreenWallpaperDetailsLocal extends UiAutomatorTestCase{
	public Marmot mm;
	public Checker cc;
	...
	public void test_0152_LockScreenWallpaperDetailsLocal() throws UiObjectNotFoundException{
		...
		cc.assertFalse("CheckButton", mm.isTextExist("應用"));
