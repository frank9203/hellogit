...
public class Test_0014_NotificationBar extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_LanchTheme() throws UiObjectNotFoundException{
		...
		//点击通知栏
		mm.log("Step 5 Check NotificationBar");
		UiObject notification = new UiObject(new UiSelector().className("android.widget.FrameLayout").index(1))
		.getChild(new UiSelector().className("android.widget.LinearLayout").index(0))
		.getChild(new UiSelector().className("android.widget.LinearLayout").index(1))
		...
		notification.click() ;
		mm.waitFor(1);
		mm.saveScreenshot("notification.png");
		mm.waitFor(1);
