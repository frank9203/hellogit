...
public class Test_0012_DesktopWallpaper extends UiAutomatorTestCase {
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_LanchTheme() throws UiObjectNotFoundException{
		...
		// 点击桌面壁纸
		mm.log("Step 5 Check DesktopWallpaper");
	...
	//	mm.click(798, 437);
		...
		mm.log("Step 7: Check Classification");
		mm.log("Step 8: Check SpecialTopic");
	...
	//	scroll.scrollToEnd(10) ;
		...
		// 查询桌面壁纸
		mm.log("Step 10:Search DesktopWallpaper");
