...
public class Test_0004_Ranking extends UiAutomatorTestCase {
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_Ranking() throws UiObjectNotFoundException{
		...
		//下载免费排行主题
		mm.log("Step 5 :Download free theme") ;
      ...
      /* //评论主题
		...
		*/
		...
		if(mm.isTextExist("资源简介")){
			scroll.swipeUp(DisplayWidth) ;
			mm.clickOnText("展开全文");
			mm.waitFor(2);
			mm.saveScreenshot("ResourcesIntroduction.png");
		}
		if(mm.isTextExist("更新日志")){
			mm.clickOnText("展开全文");
			mm.waitFor(2);
			mm.saveScreenshot("UpdateLog.png");
		}
		*/
