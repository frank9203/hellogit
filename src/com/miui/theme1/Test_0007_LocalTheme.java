...
public class Test_0007_LocalTheme extends UiAutomatorTestCase {
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_LocalTheme() throws UiObjectNotFoundException{
		...
		//点击本地
		mm.log("Step 4 Check LocalTheme");
