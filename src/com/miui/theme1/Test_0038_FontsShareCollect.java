...
public class Test_0038_FontsShareCollect extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_FontsShareCollect() throws UiObjectNotFoundException{
		...
		mm.log("Step 5 : Share and Collect Fonts");
		//针对米3适配
		mm.click(284, 555);
		mm.waitFor(2);
		//分享主题
