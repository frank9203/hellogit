...
public class Test_0003_FeaturedUiCheck extends UiAutomatorTestCase {
	Marmot mm ;
	Checker cc ;
	...
	public void test_0003_FeaturedUiCheck() throws UiObjectNotFoundException{
	...
	mm.log("Step 4 : Scroll Theme");
	//滑动主题当前界面
	UiScrollable scroll = new UiScrollable(new UiSelector().scrollable(true)) ;
	scroll.scrollToEnd(10, 20) ;
	//		scroll.scrollToEnd(20) ;
	mm.waitFor(3);
	mm.clickOnButton("热门专题");
	mm.saveScreenshot("Populartopics.png");
	scroll.scrollToEnd(10) ;
	mm.pressBack();
	mm.clickOnButton("人气精选");
	mm.saveScreenshot("PopularPicks.png");
	scroll.scrollToEnd(10) ;
	mm.pressBack();
	mm.clickOnButton("兑换");
	mm.waitFor(2);
	...
	//搜索主题
	mm.log("Step 5 : Search for theme");
