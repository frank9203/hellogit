...
public class Test_0002_TermsCondittions extends UiAutomatorTestCase {
	...
	public void test_0002_TermsCondittions() throws UiObjectNotFoundException{
		...
		mm.log("Step 3 : Judge TermsConditions");
		mm.pressHome();
		mm.clickOnText("主题风格");
		mm.waitFor(3);
		...
		mm.log("Step 4 : Check XiaoMiAccount");
		//判断小米账户是否登录
