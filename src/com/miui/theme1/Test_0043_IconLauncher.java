...
public class Test_0043_IconLauncher extends UiAutomatorTestCase{
	Marmot mm ;
	Checker cc ;
	...
	public void test_0001_IconLaucher() throws UiObjectNotFoundException{
		...
		mm.log("Step 4 : Check IconLauncher");
