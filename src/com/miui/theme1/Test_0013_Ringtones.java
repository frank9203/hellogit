...
public class Test_0013_Ringtones extends UiAutomatorTestCase {
	Marmot mm ;
	Checker cc ;
	...
	//点击混搭
		...
		UiObject Ringtones = new UiObject(new UiSelector().className("android.widget.FrameLayout").index(1))
		.getChild(new UiSelector().className("android.widget.LinearLayout").index(0))
